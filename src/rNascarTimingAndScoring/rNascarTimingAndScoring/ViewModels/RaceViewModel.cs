...
namespace rNascarTimingAndScoring.ViewModels
{
    public class RaceViewModel : ViewModelBase, IRaceViewModel
    {
        ...
        protected virtual async Task<NascarApi.Models.LiveFeed.RootObject> GetLiveFeedAsync()
        {
            return await ApiClient.GetLiveFeedAsync();
        }

        protected virtual async Task<IList<NascarApi.Models.LivePoints.RootObject>> GetPointsFeedAsync()
        {
            return await ApiClient.GetLivePointsAsync(EventSettings);
        }

        protected virtual async Task<NascarApi.Models.LapAverage.RootObject> GetLapAverageFeedAsync()
        {
